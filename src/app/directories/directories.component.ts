...
export class DirectoriesComponent {
  ...
  //region: Create group of directories
  isVisible = false;
  modalTitle = 'Создать группу справочников';

  isVisibleDirectory = false;
  modalTitleDirectory = 'Создать справочник';
  ...
  openCreateDirectoryModal(): void {
    this.isVisibleDirectory = true;
    this.modalTitleDirectory;
  }
